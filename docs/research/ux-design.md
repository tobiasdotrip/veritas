...
**Mise en garde :** si < 10 votes communs, affichage d'un bandeau d'avertissement : *"Score calculé sur un nombre limité de scrutins. Pour une analyse plus fiable, élargissez la période."*
